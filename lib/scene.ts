...
export function createScene(host:HTMLElement,onSelect:(id:string)=>void,onManual:()=>void):SceneAPI{
 ...
 let lightMode='day';const themes:Record<string,{bg:string;water:string;sun:string;ambient:number;power:number;emission:number}>={day:{bg:'#68a9e4',water:'#688d96',sun:'#fff5e5',ambient:1.55,power:2.8,emission:0},sunset:{bg:'#403957',water:'#9b8657',sun:'#ff985d',ambient:.7,power:1.15,emission:.62},night:{bg:'#07172f',water:'#173b54',sun:'#8eb8ff',ambient:.3,power:.4,emission:.78}};
